...
import { Box,Container,Grid,Stack,TextField,CircularProgress } from "@mui/material";
...
export default function EditProfile(props) {
  ...
  // const [profile,setProfile] = useState({age:null,occupation:null,schOrEmployer:null,purpose:null,skills:null});
  ...
  const retrieveProfile= async () => {
      ...
      const response=await axios.get("http://localhost:3002/api/v1/user/retrieveProfile",
                      ...
                      .then((res)=>{
                        ...
                        setSchOrEmployer(res.data.schOrEmployer);
                        setPurpose(res.data.purpose);
                        console.log('res.data.skills',res.data.skills);
                        const skills=[...res.data.skills]
                        setSkills(skills);
                        console.log('sklls',skills);
                        // setProfile({age:age,occupation:occupation,schOrEmployer:schOrEmployer,purpose:purpose,skills:skills});
  ...
  // console.log('currentProfile:',profile.age);
  ...
  return !isLoggedIn ? (
    ...
    {/* <CircularProgress open={loadingProfile} /> */}
      <Container  >
          ...
          <Grid item xs={12}>
            ...
            <AutocompleteInput
              ...
              onChange={(event, newValue) => {
                console.log('newValue for skills:',newValue);
